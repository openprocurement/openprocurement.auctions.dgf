...
def not_found(self):
    ...
    response = self.app.post('/auctions/{}/cancellations/some_id/documents'.format(self.auction_id), status=404,
    ...
    response = self.app.post(
        '/auctions/{}/cancellations/{}/documents'.format(self.auction_id, self.cancellation_id), status=404,
        upload_files=[
    ...
    response = self.app.get('/auctions/{}/cancellations/some_id/documents/some_id'.format(self.auction_id),
                            status=404)
    self.assertEqual(response.status, '404 Not Found')
    self.assertEqual(response.content_type, 'application/json')
    self.assertEqual(response.json['status'], 'error')
    ...
    response = self.app.get(
        '/auctions/{}/cancellations/{}/documents/some_id'.format(self.auction_id, self.cancellation_id), status=404)
    self.assertEqual(response.status, '404 Not Found')
    self.assertEqual(response.content_type, 'application/json')
    self.assertEqual(response.json['status'], 'error')
    self.assertEqual(response.json['errors'], [
    ...
    response = self.app.put('/auctions/{}/cancellations/some_id/documents/some_id'.format(self.auction_id),
...
def create_auction_cancellation_document(self):
    ...
    response = self.app.get(
        '/auctions/{}/cancellations/{}/documents?all=true'.format(self.auction_id, self.cancellation_id))
    self.assertEqual(response.status, '200 OK')
    self.assertEqual(response.content_type, 'application/json')
    self.assertEqual(doc_id, response.json["data"][0]["id"])
    self.assertEqual('name.doc', response.json["data"][0]["title"])
...
def put_auction_cancellation_document(self):
    ...
    response = self.app.put(
        '/auctions/{}/cancellations/{}/documents/{}'.format(self.auction_id, self.cancellation_id, doc_id),
        status=404,
