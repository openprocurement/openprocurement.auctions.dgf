...
def not_found(self):
    ...
    response = self.app.post('/auctions/{}/complaints/some_id/documents'.format(self.auction_id), status=404,
    ...
    response = self.app.post('/auctions/{}/complaints/{}/documents'.format(self.auction_id, self.complaint_id),
    ...
    response = self.app.get(
        '/auctions/{}/complaints/{}/documents/some_id'.format(self.auction_id, self.complaint_id), status=404)
    self.assertEqual(response.status, '404 Not Found')
    self.assertEqual(response.content_type, 'application/json')
    self.assertEqual(response.json['status'], 'error')
    self.assertEqual(response.json['errors'], [
    ...
    response = self.app.put('/auctions/{}/complaints/some_id/documents/some_id'.format(self.auction_id), status=404,
                            upload_files=[
